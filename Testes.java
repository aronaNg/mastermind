...
public class Testes {
    ...
    public static void main(String[] args) {
        ...
        frame.setSize(440, 880);

        // Crée un JPanel avec un GridLayout
        JPanel buttonPanel = new JPanel(new GridLayout(16, 7)); // grille de 12 lignes, 7 colonnes
        ...
        ImageIcon IL10C7 = new ImageIcon("Image\\L10C7.gif");
        ...
        java.awt.event.ActionListener buttonActionListener = new java.awt.event.ActionListener() {
            @Override
        ...
        for (int row = 0; row < 16; row++) {
            for (int col = 0; col < 8; col++) {
                ...
                ImageIcon scaledIcon = getScaledImageIcon(image, 53, 53);
                button = new JButton(scaledIcon);
                button.setActionCommand("Button " + (row * 8 + col + 1));
                button.addActionListener(buttonActionListener);


                if(col==6 && row==10)
                    button.setPressedIcon( getScaledImageIcon(IBValideClic, 55, 55));
